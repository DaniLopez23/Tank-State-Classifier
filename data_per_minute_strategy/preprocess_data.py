...
OUTPUT_FILE = f"data_per_minute_strategy/merged_data/merged_data_{DATE}.csv"
...
def merge_data(temp_file, imu_file, output_file):
    ...
    merged_df = pd.merge_asof(temp_df.sort_values("DateTime"),
                              imu_df.sort_values("DateTime"),
                              on="DateTime",
                              direction="backward")
